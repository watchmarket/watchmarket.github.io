...
(function() {
     ...
     * ✅ Using event delegation to ensure handler works even if element loads after script
     */
    $(document).on('change', '.posisi-check', function () {
     ...
     * ✅ Using event delegation to ensure handler works even if element loads after script
     */
    $(document).on('click', '#ManajemenKoin', function(e){
      console.log('[UI HANDLER] ManajemenKoin clicked!'); // DEBUG
      e.preventDefault();

      console.log('[UI HANDLER] Calling showMainSection...'); // DEBUG
      ...
      console.log('[UI HANDLER] Calling renderTokenManagementList...'); // DEBUG
      renderTokenManagementList();
      console.log('[UI HANDLER] ManajemenKoin handler completed!'); // DEBUG
    });
