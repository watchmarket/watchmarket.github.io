...
async function deferredInit() {
    ...
    // ❌ REMOVED: Duplicate event handler for #ManajemenKoin
    // Handler already exists in core/handlers/ui-handlers.js
    // $('#ManajemenKoin').on('click', ...) - REMOVED TO FIX CONFLICT
    ...
    // ❌ REMOVED: Duplicate event handler for #UpdateWalletCEX
    // Handler already exists in core/handlers/wallet-handlers.js
    // $('#UpdateWalletCEX').on('click', ...) - REMOVED TO FIX CONFLICT
...
(function initBulkModalEditor() {
    ...
    // Save last selected profile index for a chain (temporary cache, not critical data)
